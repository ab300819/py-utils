...
base_login = "https://www.zhihu.com/login/"

# 一定不能写成http,否则无法登录
session = requests.Session()
session.cookies = http.cookiejar.LWPCookieJar(filename='../resources/ZhiHuCookies')
...
# 保存图片
with open('../resources/test_code.gif', 'wb') as f:
    f.write(gif.content)

# 输入验证码
captcha = input('captcha: ')
data = {"captcha": captcha, "password": password, "_xsrf": _xsrf, }
